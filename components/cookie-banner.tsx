...
export function CookieBanner() {
  ...
  const closeBanner = (callback: () => void) => {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background p-6 md:bottom-8 md:left-8 md:right-auto md:max-w-[380px] md:border md:shadow-none opacity-0"
    >
