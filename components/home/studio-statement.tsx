...
export function StudioStatement() {
  return (
    <section className="flex min-h-[90svh] flex-col justify-center bg-foreground px-[5vw] py-24 md:py-32 lg:py-48 text-background">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center space-y-16 md:space-y-24 lg:space-y-32">
        ...
        <Reveal delay={0.4} className="pt-8">
          <Link
            href="/contact"
            className="group/cta inline-flex items-center gap-3 font-mono text-xs uppercase tracking-widest text-background hover:text-background/80 transition-colors"
          >
            <span className="border-b border-background/40 pb-1">LET'S BUILD SOMETHING</span>
